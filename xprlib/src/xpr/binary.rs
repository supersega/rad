...
where  L: Copy + Clone, R: Copy + Clone {
...
#[derive(Copy, Clone, Debug)]
pub struct AddXpr<L: Copy + Clone, R: Copy + Clone>(BinXpr<L, R>);

/// Implement Assign trait for AddXpr
impl<L: Copy + Clone + Assign, R: Copy + Clone + Assign> Assign for AddXpr<L, R> {
...
#[derive(Copy, Clone, Debug)]
pub struct SubXpr<L: Copy + Clone, R: Copy + Clone>(BinXpr<L, R>);

/// Implement Assign trait for SubXpr
impl<L: Copy + Clone + Assign, R: Copy + Clone + Assign> Assign for SubXpr<L, R> {
    fn assign(&self, target: &mut Dual) {
        self.0.l.assign(target);
        self.0.r.assign_sub(target);
    }
...
#[derive(Copy, Clone, Debug)]
pub struct MulXpr<L: Copy + Clone, R: Copy + Clone>(BinXpr<L, R>);

/// Implement Assign trait for MulXpr
impl<L: Copy + Clone + Assign, R: Copy + Clone + Assign> Assign for MulXpr<L, R> {
    fn assign(&self, target: &mut Dual) {
        self.0.l.assign(target);
...
#[derive(Copy, Clone, Debug)]
pub struct DivXpr<L: Copy + Clone, R: Copy + Clone>(BinXpr<L, R>);

/// Implement Assign trait for DivXpr
impl<L: Copy + Clone + Assign, R: Copy + Clone + Assign> Assign for DivXpr<L, R> {
    fn assign(&self, target: &mut Dual) {
        self.0.l.assign(target);
...
macro_rules! impl_bin_op(
    ($Op: ident, $op: ident, $Res: ident) => {
        ...
        impl<R: Copy + Clone> $Op<XprWrapper<R>> for Dual {
        ...
        impl<'l, R: Copy + Clone> $Op<XprWrapper<R>> for &'l Dual {
            type Output = XprWrapper<$Res<Dual, R>>;
            fn $op(self, other: XprWrapper<R>) -> Self::Output {
        ...
        impl<'r, R: Copy + Clone> $Op<&'r XprWrapper<R>> for Dual {
            type Output = XprWrapper<$Res<Dual, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self, r: other.xpr})}
            }
        ...
        impl<'l, 'r, R: Copy + Clone> $Op<&'r XprWrapper<R>> for &'l Dual {
            type Output = XprWrapper<$Res<Dual, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.clone(), r: other.xpr})}
            }
        ...
        impl<L: Copy + Clone> $Op<Dual> for XprWrapper<L> {
        ...
        impl<'r, L: Copy + Clone> $Op<&'r Dual> for XprWrapper<L> {
            type Output = XprWrapper<$Res<L, Dual>>;
            fn $op(self, other: &Dual) -> Self::Output {
        ...
        impl<'l, L: Copy + Clone> $Op<Dual> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, Dual>>;
            fn $op(self, other: Dual) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other})}
            }
        ...
        impl<'l, 'r, L: Copy + Clone> $Op<&'r Dual> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, Dual>>;
            fn $op(self, other: &Dual) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.clone()})}
            }
        ...
        impl<L: Copy + Clone, R: Copy + Clone> $Op<XprWrapper<R>> for XprWrapper<L> {
        ...
        impl<'r, L: Copy + Clone, R: Copy + Clone> $Op<&'r XprWrapper<R>> for XprWrapper<L> {
            type Output = XprWrapper<$Res<L, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.xpr})}
            }
        ...
        impl<'l, L: Copy + Clone, R: Copy + Clone> $Op<XprWrapper<R>> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, R>>;
            fn $op(self, other: XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.xpr})}
            }
        ...
        impl<'l, 'r, L: Copy + Clone, R: Copy + Clone> $Op<&'r XprWrapper<R>> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.xpr})}
            }
        ...
        impl<L: Copy + Clone> $Op<f64> for XprWrapper<L> {
        ...
        impl<'r, L: Copy + Clone> $Op<&'r f64> for XprWrapper<L> {
            type Output = XprWrapper<$Res<L, ConstantXpr>>;
            fn $op(self, other: &f64) -> Self::Output {
        ...
        impl<'l, L: Copy + Clone> $Op<f64> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, ConstantXpr>>;
            fn $op(self, other: f64) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.into()})} 
            }
        ...
        impl<'l, 'r, L: Copy + Clone> $Op<&'r f64> for &'l XprWrapper<L> {
            type Output = XprWrapper<$Res<L, ConstantXpr>>;
            fn $op(self, other: &f64) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.xpr, r: other.clone().into()})} 
            }
        ...
        impl<R: Copy + Clone> $Op<XprWrapper<R>> for f64 {
        ...
        impl<'l, R: Copy + Clone> $Op<XprWrapper<R>> for &'l f64 {
            type Output = XprWrapper<$Res<ConstantXpr, R>>;
            fn $op(self, other: XprWrapper<R>) -> Self::Output {
        ...
        impl<'r, R: Copy + Clone> $Op<&'r XprWrapper<R>> for f64 {
            type Output = XprWrapper<$Res<ConstantXpr, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.into(), r: other.xpr})}
            }
        ...
        impl<'l, 'r, R: Copy + Clone> $Op<&'r XprWrapper<R>> for &'l f64 {
            type Output = XprWrapper<$Res<ConstantXpr, R>>;
            fn $op(self, other: &XprWrapper<R>) -> Self::Output {
                Self::Output{xpr: $Res(BinXpr{l: self.clone().into(), r: other.xpr})}
            }
